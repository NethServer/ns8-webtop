...
container=$(buildah from docker.io/library/tomcat:9.0.109-jre8)
...
container=$(buildah from docker.io/library/postgres:17.6)
...
container=$(buildah from docker.io/library/php:7.3-fpm-alpine)
buildah copy --from=docker.io/mlocati/php-extension-installer:2.9.18 ${container} /usr/bin/install-php-extensions /usr/local/bin/
